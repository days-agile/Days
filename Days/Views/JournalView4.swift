...
struct JournalView4: View {
                ...
                VStack {
                    HStack {
                        ...
                        ZStack {
                            ...
                            Circle()
                                .trim(from: 0, to: 1.0) // Adjust 'to' value based on page completion
                    ...
                    Text("What are my daily goals for tomorrow?")
    ...
    struct JournalView4_Previews: PreviewProvider {
